...
public class TelegramApiRequestException_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.telegram.telegrambots.meta.exceptions.TelegramApiRequestException"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TelegramApiRequestException_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.json.JSONObject", false, TelegramApiRequestException_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.telegram.telegrambots.meta.api.objects.replykeyboard.ApiResponse", false, TelegramApiRequestException_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TelegramApiRequestException_ESTest_scaffolding.class.getClassLoader()); 
